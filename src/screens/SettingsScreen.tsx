...
type Section = "general" | "security" | "backup";
...
export function SettingsScreen() {
  ...
  const sections: { id: Section; label: string }[] = [
    ...
    { id: "security", label: t("settings.sectionSecurity") },
    { id: "backup", label: t("settings.sectionBackup") },
  ];
  ...
  return (
    <div className="content settings-page">
      ...
      <div className="settings-layout">
        <nav className="settings-nav" aria-label={t("settings.title")}>
          {sections.map((s) => (
            <button
              key={s.id}
              type="button"
              className={`settings-nav__item${section === s.id ? " is-active" : ""}`}
        ...
        <div className="settings-pane anim-page" key={section}>
          {section === "general" ? (
            <div className="settings-group">
              <div className="settings-section">
                <h3 className="settings-section__head">
                ...
                <div className="settings-control">
                  ...
                  <NumberStepper
                    ...
                    onChange={(n) => void savePatch({ autoLockMinutes: n }, "autoLockMinutes")}
                  />
                </div>
              </div>
          ...
          {section === "security" ? (
            <div className="settings-group">
              ...
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.preset")}</h3>
              ...
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.passwordSection")}</h3>
              ...
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.tor")}</h3>
              ...
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.fixedfloat")}</h3>
          ...
          {section === "backup" ? (
            <div className="settings-group">
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.vaultBackup")}</h3>
              ...
              <div className="settings-section">
                <h3 className="settings-section__head">{t("settings.wipeWallet")}</h3>
