...
Quiet self-custody for Windows.

Opal is a desktop wallet built with Tauri 2 and React. Software portfolios, Trezor hardware, and watch-only addresses live in one sidebar. Keys for software wallets stay in an encrypted local vault; Trezor keys never leave the device.
...
Windows installers ship via GitHub Actions. How to cut a release: [docs/releasing.md](docs/releasing.md)
